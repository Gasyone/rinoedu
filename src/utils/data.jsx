...
window.Data = {
    ...
    ACCOUNT_TABS: [
        // Tài khoản cá nhân
        { id: 'profile', label: 'Hồ sơ cá nhân', icon: window.Icons.IdCard, category: 'Tài khoản' },
        { id: 'security', label: 'Bảo mật & Liên kết', icon: window.Icons.Shield, category: 'Tài khoản' },
        { id: 'general', label: 'Cài đặt chung', icon: window.Icons.Sliders, category: 'Tài khoản' },
        { id: 'subscription', label: 'Gói dịch vụ', icon: window.Icons.CreditCard, category: 'Tài khoản' },

        // Quản lý nền tảng Rino
        { id: 'org_overview', label: 'Tổng quan nền tảng', icon: window.Icons.PieChart, category: 'Quản lý Nền tảng' },
        { id: 'org_members', label: 'Thành viên Rino', icon: window.Icons.Users, category: 'Quản lý Nền tảng' },
        { id: 'org_settings', label: 'Cài đặt nền tảng', icon: window.Icons.Building, category: 'Quản lý Nền tảng' },

        // Quản trị hệ thống
        { id: 'sys_users', label: 'Người dùng hệ thống', icon: window.Icons.Server, category: 'Quản trị Hệ thống' },
        { id: 'sys_logs', label: 'Nhật ký hệ thống', icon: window.Icons.History, category: 'Quản trị Hệ thống' },
    ],
    ...
    NOTIFICATIONS_MOCK: [
        { id: 1, type: 'work', title: 'Phê duyệt nghỉ phép', desc: 'Nguyễn Văn A đã gửi yêu cầu nghỉ phép 2 ngày.', time: '10 phút trước', read: false, priority: 'high', group: 'today' },
        ...
        { id: 5, type: 'security', title: 'Đăng nhập lạ', desc: 'Phát hiện đăng nhập từ thiết bị mới tại Đà Nẵng.', time: 'Hôm qua, 09:00', read: true, priority: 'high', group: 'yesterday' },
    ],
